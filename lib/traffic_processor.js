...
Processor.prototype._averagePerCode = function(cb) {
  var dataPoints = [];
  var self = this;
  this.events.distinct(function(o) { return o.statusCode }).count().subscribe(function(e) {
    var total = e;
    var processed = 0;
    var statusCodes = self.events
      .groupBy(function(o) {
        return o.statusCode;  
...
Processor.prototype._averagePerPath = function(cb) {
  var dataPoints = [];
  var self = this;
  this.events.distinct(function(o) { return o.url }).count().subscribe(function(e) {
    var total = e; 
    var processed = 0;
    var okStatusCode = self.events
      .groupBy(function(o) {
         return o.url; 
      }).subscribe(function(obs) {
        var avg = obs
